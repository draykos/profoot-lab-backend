...
export interface ApiAllenamentoAllenamento extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    categoria: Schema.Attribute.Enumeration<
      ['forza', 'attivazione', 'defaticamento', 'velocita', 'core', 'condizionamento', 'recupero']
    >;
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::allenamento.allenamento'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiAtletaAtleta extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    allenamenti: Schema.Attribute.Relation<'oneToMany', 'api::allenamento.allenamento'>;
    ...
    highlights: Schema.Attribute.Relation<'oneToMany', 'api::highlight.highlight'>;
    infortuni: Schema.Attribute.Relation<'oneToMany', 'api::infortunio.infortunio'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::atleta.atleta'> &
      Schema.Attribute.Private;
    ...
    >;
    piedePreferito: Schema.Attribute.Enumeration<['destro', 'sinistro', 'ambidestro']>;
    proStatus: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    publishedAt: Schema.Attribute.DateTime;
    ruolo: Schema.Attribute.Enumeration<['portiere', 'difensore', 'centrocampista', 'attaccante']>;
    squadra: Schema.Attribute.String;
    testFisici: Schema.Attribute.Relation<'oneToMany', 'api::test-fisico.test-fisico'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    user: Schema.Attribute.Relation<'oneToOne', 'plugin::users-permissions.user'>;
    videoCoach: Schema.Attribute.Relation<'oneToMany', 'api::video-coach.video-coach'>;
  };
}
...
export interface ApiHighlightHighlight extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::highlight.highlight'> &
      Schema.Attribute.Private;
...
export interface ApiInfortunioInfortunio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::infortunio.infortunio'> &
      Schema.Attribute.Private;
    ...
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    vista: Schema.Attribute.Enumeration<['fronte', 'retro']> & Schema.Attribute.Required;
...
export interface ApiPartitaPartita extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    golTrasferta: Schema.Attribute.Integer &
      ...
      >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::partita.partita'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    squadraCasa: Schema.Attribute.String;
    squadraTrasferta: Schema.Attribute.String;
    stadio: Schema.Attribute.String;
    stato: Schema.Attribute.Enumeration<['in_programma', 'giocata', 'rinviata']> &
...
export interface ApiPianoAlimentarePianoAlimentare extends Struct.CollectionTypeSchema {
...
export interface ApiTestFisicoTestFisico extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::test-fisico.test-fisico'> &
      Schema.Attribute.Private;
    note: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    tipo: Schema.Attribute.Enumeration<
    ...
    > &
      Schema.Attribute.Required;
    unita: Schema.Attribute.Enumeration<['cm', 's', 'm']> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
...
export interface ApiVideoCoachVideoCoach extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    durataMinuti: Schema.Attribute.Integer &
      ...
      >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::video-coach.video-coach'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titolo: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
